...
k = 1;
N = t*k/(0.01);
traj1 = CartesianTrajectory(Tse_initial, Tse_standoff_initial, t, N, 5);
...
traj2 = CartesianTrajectory(Tse_standoff_initial, Tse_grasp, t, N, 5);
...
gripper_state = 1;
traj3 = CartesianTrajectory(Tse_grasp, Tse_grasp, t, N, 5);
